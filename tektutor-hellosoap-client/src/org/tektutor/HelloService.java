 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://tektutor.org", wsdlLocation = "http://localhost:8080/hello-ws/services/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://tektutor.org", "HelloService");
    ...
    public Hello getHello() {
        return super.getPort(new QName("http://tektutor.org", "Hello"), Hello.class);
    }
    ...
    public Hello getHello(WebServiceFeature... features) {
        return super.getPort(new QName("http://tektutor.org", "Hello"), Hello.class, features);
    }
